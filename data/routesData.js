// Справочник предустановленных маршрутов
...
const routes = [
...

  {
    ...
    distanceKm: 4,             // условная средняя точка диапазона "3-5 км"
    ...
    // Заглушка: маршрут будет активирован после импорта полного 2GIS-трека.
...

  {
    ...
    // Здесь уже есть тестовые точки в мини-приложении, можно позже перенести:
