...
class CommandHandler {
    ...
    async handleHelp(chatId) {
        const helpText = 
            ...
            '1) Нажмите «Построить маршрут» для свободной тренировки или «Маршруты Ставрополья» для готовых троп.\n' +
            '2) Для быстрых вариантов рядом используйте «Рядом со мной» и дайте геолокацию.\n' +
            '3) В mini-app нажмите «Старт», двигайтесь по маршруту и завершите тренировку кнопкой «Стоп».\n' +
            '4) История, статистика, профиль и сохранённые результаты теперь доступны внутри mini-app.\n\n' +
            'Команды:\n' +
            '/start — главное меню\n' +
            '/help — эта справка';
